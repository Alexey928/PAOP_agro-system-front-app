...
import {taskTypeConvertEmun, TypesOfTask} from "../Forms/TaskParamForm";
             ...
             <div className={style.materials_contayner}>
                 {
                     curentTascMaterialData && curentMaterials ?
                         ...
                         return(
                             <div className={style.task_material_information}>
                                 <div>


                                     <h2>{curentMaterials[i].type}</h2>
                                     <div>
                                         {curentMaterials[i].name} : {el.plannedMaterialAmount}
                                         {curentMaterials[i].cValue} {
                                             curentMaterials[i].type==="насіння"?`~~ == 
                                             ${Math.round(el.plannedMaterialAmount/curentMaterials[i].packaging)} пакунків`:
                                             ` Вода : 430000л`
                                     }
                                     </div>
                                 </div>
